 ...
 * X's mark.
 *
 * Inlined as a path rather than pulled from an icon package, for the same
 * reason the Fuji is: one 24-unit path does not justify a dependency, and it
 * inherits `currentColor` so the header and the footer can each tint it without
 * shipping two files.
 */
